...
window.PA_TASKS = [
  ...
  { id:'atlantic', name:'The Atlantic — Quote + Intro Call', section:'Media Relations', owner:'Lauren', status:'In Progress', goals:['CI'], due:'2026-05-13', notes:'Atlantic story may include a quote from Michael + learn more about CodePath' },
  ...
  { id:'newprofit', name:'New Profit Story', section:'Content Development', owner:'Lauren', status:'In Progress', goals:['EM'], due:'2026-05-13' },
  ...
  { id:'aifh', name:'AI for Humanity Awards', section:'Recognition / Awards', owner:'Lauren', status:'In Progress', goals:['PR'], due:'2026-05-29' },
  ...
  { id:'devoffsite', name:'Development Team Offsite (Louisville, KY)', section:'External Event Prep', owner:'Lauren', status:'In Progress', goals:['IN'], due:'2026-05-18' },
  ...
  { id:'wallerstein', name:'Learning + Strategy call w/ Wallerstein + Michael', section:'Government Relations', owner:'Lauren', status:'In Progress', goals:['GP'], due:'2026-05-14' },
  ...
  // ---- Beyond Q2 (Q3+) ----
  { id:'jffhorizons', name:'JFF Horizons', section:'External Event Prep', owner:'Madison', wa:true, status:'In Progress', goals:['AP','ES','RT','CI'], due:'2026-07-13', beyond:true },
  { id:'jffknowledge', name:'JFF Horizons — Knowledge Network Kickoff', section:'Hosted Convenings', owner:'Lauren', status:'In Progress', goals:['AP','ES','RT','CI'], due:'2026-07-13', beyond:true },
  { id:'mdanthropic', name:'State of Maryland + Anthropic (JFF Horizons)', section:'Hosted Convenings', owner:'Madison', status:'Pending', goals:['AP','ES','RT','CI'], due:'2026-07-13', beyond:true },
  { id:'uncfunite', name:'UNCF Unite', section:'External Event Prep', owner:'Madison', status:'Pending', goals:['ES'], due:'2026-07-15', event:'2026-07-20', beyond:true },
